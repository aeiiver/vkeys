...
{
    switch (code) {
    case SDL_SCANCODE_1:         return 0 + 7;
    case SDL_SCANCODE_2:         return 1 + 7;
    case SDL_SCANCODE_3:         return 2 + 7;
    case SDL_SCANCODE_4:         return 3 + 7;
    case SDL_SCANCODE_5:         return 4 + 7;
    case SDL_SCANCODE_6:         return 5 + 7;
    case SDL_SCANCODE_7:         return 6 + 7;
    case SDL_SCANCODE_8:         return 7 + 7;
    case SDL_SCANCODE_9:         return 8 + 7;
    case SDL_SCANCODE_0:         return 9 + 7;

    case SDL_SCANCODE_Q:         return 0 + 0;
    case SDL_SCANCODE_W:         return 1 + 0;
    case SDL_SCANCODE_E:         return 2 + 0;
    case SDL_SCANCODE_R:         return 3 + 0;
    case SDL_SCANCODE_T:         return 4 + 0;
    case SDL_SCANCODE_Y:         return 5 + 0;
    case SDL_SCANCODE_U:         return 6 + 0;
    case SDL_SCANCODE_I:         return 7 + 0;
    case SDL_SCANCODE_O:         return 8 + 0;
    case SDL_SCANCODE_P:         return 9 + 0;

    case SDL_SCANCODE_A:         return 0 + -7;
    case SDL_SCANCODE_S:         return 1 + -7;
    case SDL_SCANCODE_D:         return 2 + -7;
    case SDL_SCANCODE_F:         return 3 + -7;
    case SDL_SCANCODE_G:         return 4 + -7;
    case SDL_SCANCODE_H:         return 5 + -7;
    case SDL_SCANCODE_J:         return 6 + -7;
    case SDL_SCANCODE_K:         return 7 + -7;
    case SDL_SCANCODE_L:         return 8 + -7;
    case SDL_SCANCODE_SEMICOLON: return 9 + -7;

    case SDL_SCANCODE_Z:         return 0 + -14;
    case SDL_SCANCODE_X:         return 1 + -14;
    case SDL_SCANCODE_C:         return 2 + -14;
    case SDL_SCANCODE_V:         return 3 + -14;
    case SDL_SCANCODE_B:         return 4 + -14;
    case SDL_SCANCODE_N:         return 5 + -14;
    case SDL_SCANCODE_M:         return 6 + -14;
    case SDL_SCANCODE_COMMA:     return 7 + -14;
    case SDL_SCANCODE_PERIOD:    return 8 + -14;
    case SDL_SCANCODE_SLASH:     return 9 + -14;
